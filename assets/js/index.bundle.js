	...
	var e,
		t = {
			...
			647: (e, t, n) => {
				...
				new (s())(l, { tolerance: { up: 5, down: 10 } }).init();
				var c = n(740);
				...
				document.querySelectorAll("[data-bp]").forEach((e) => {
					...
					e.addEventListener("click", (e) => {
						let n = { el: e.target, noLoader: !0 };
						if (t.parentGalleryClass) {
							const e = document.querySelectorAll(
								`.${t.parentGalleryClass} [data-bp]`
							);
							let r = [];
							e.forEach((e) => {
				...
				document.querySelectorAll("[data-filter]").forEach(function (e) {
					e.addEventListener("click", () => {
						...
						for (var o = 0; o < r.length; o++) r[o].classList.remove("current");
						e.classList.add("current"), E().data(n).arrange({ filter: t });
					});
				}),
			...
			316: () => {
				document.querySelectorAll("[data-countdown]").forEach(function (e) {
					setInterval(function () {
						...
						const l = `<div class="countdown-item"><div class="countdown-value"><span>${(o =
								n(o))}</span> days</div></div>`,
							c = `<div class="countdown-item"><div class="countdown-value"><span>${(a =
								n(a))}</span> hours</div></div>`,
							u = `<div class="countdown-item"><div class="countdown-value"><span>${(i =
								n(i))}</span> minutes</div></div>`,
							f = `<div class="countdown-item"><div class="countdown-value"><span>${(s =
								n(s))}</span> seconds</div></div>`;
						e.innerHTML = l + c + u + f;
					}, 10);
				});
			},
				...
				!(function (o, a, i) {
					...
					function s(e) {
						if (
							...
							for (var t in e.easing) U[t] = e.easing[t];
					...
					var l,
						...
						K = function () {
							var e =
									...
									o[B.toLowerCase() + "RequestAnimationFrame"],
								t = Ce();
							return (
								(ze || !e) &&
									(e = function (e) {
					...
					(s.prototype.refresh = function (e) {
						...
						for (
							...
							if ((r && C in o && delete o[C], o.attributes)) {
											...
											if ("data-edge-strategy" !== v.name)
												if ("data-emit-events" !== v.name) {
													...
													if (null !== m) {
														...
														/p$/.test(b)
															? ((g.isPercentage = !0),
															  (g.offset = (0 | b.slice(0, -1)) / 100))
															: (g.offset = 0 | b);
														var T = m[3],
															S = m[4] || T;
														T && "start" !== T && "end" !== T
															? ((g.mode = "relative"), (g.anchors = [T, S]))
															: ((g.mode = "absolute"),
															  "end" === T
																	? (g.isEnd = !0)
																	: g.isPercentage ||
																	  (g.offset = g.offset * He));
													}
												} else f = !0;
											else u = v.value;
										else c = "off" !== v.value;
								...
								l.length &&
									(!r && C in o
										? ((k = o[C]), (w = ie[k].styleAttr), (E = ie[k].classAttr))
										: ((k = o[C] = _e++), (w = o.style.cssText), (E = Le(o))),
									(ie[k] = {
										element: o,
										styleAttr: w,
										classAttr: E,
						...
						(s.prototype.stopAnimateTo = function () {
							de && de.done && de.done.call(ae, !0), (de = i);
						}),
						...
						(s.prototype.off = function (e) {
							return delete le[e], ae;
						}),
						(s.prototype.destroy = function () {
							(function () {
								var e =
									o.cancelAnimationFrame ||
									o[B.toLowerCase() + "CancelAnimationFrame"];
								return (
									(ze || !e) &&
										(e = function (e) {
								...
								we(),
								Oe(l, [E], [w, k, A]);
							for (var e = 0, t = ie.length; t > e; e++) re(ie[e].element);
					...
					var Y = function () {
							...
							Te(l, [v, m, g, h].join(" "), function (o) {
								...
								for (r = o.target; 3 === r.nodeType; ) r = r.parentNode;
								switch (
									((s = l.clientY),
									(u = l.clientX),
									(y = o.timeStamp),
						...
						R = function (e, t) {
							for (var n = 0, r = ie.length; r > n; n++) {
								var o,
									...
									E = i.lastFrameIndex;
								if (m || g) {
									if ((m && -1 === i.edge) || (g && 1 === i.edge)) continue;
									switch (
										(m
											? (Oe(s, [b], [S, T]),
											  w &&
													E > -1 &&
													(Ee(s, p.eventType, Me), (i.lastFrameIndex = -1)))
											: (Oe(s, [S], [b, T]),
											  w &&
													d > E &&
													(Ee(s, v.eventType, Me), (i.lastFrameIndex = d))),
										(i.edge = m ? -1 : 1),
										i.edgeStrategy)
									) {
										case "reset":
										...
										case "set":
											...
											for (o in k)
												f.call(k, o) &&
													((a = ne(k[o].value)),
													0 === o.indexOf("@")
														? s.setAttribute(o.substr(1), a)
														: u.setStyle(s, o, a));
											continue;
									}
								} else 0 !== i.edge && (Oe(s, [y, T], [b, S]), (i.edge = 0));
								for (var A = 0; d - 1 > A; A++)
									if (l >= c[A].frame && c[A + 1].frame >= l) {
										...
										w &&
											E !== A &&
											(Ee(s, "down" === Me ? x.eventType : L.eventType, Me),
											(i.lastFrameIndex = A));
										break;
									}
							}
						...
						X = function () {
							...
							if (
								(de
									? (r >= de.endTime
											? ((n = de.targetTop), (e = de.done), (de = i))
											: ((t = de.easing((r - de.startTime) / de.duration)),
								...
								!1 !== (le.beforerender && le.beforerender.call(ae, o)) &&
									(R(n, ae.getScrollTop()),
									(De = n),
						...
						W = function (e) {
							for (var t = 0, n = e.keyFrames.length; n > t; t++) {
								for (
									var r, o, a, i, s = e.keyFrames[t], l = {};
									null !== (i = M.exec(s.props));
						...
						ee = function (e, t) {
							var n;
							for (n in t) f.call(e.props, n) || (e.props[n] = t[n]);
						...
						te = function (e, t, n) {
							...
							var a = [e[0]];
							for (r = 1; o > r; r++) a[r] = e[r] + (t[r] - e[r]) * n;
							return a;
						},
						ne = function (e) {
							var t = 1;
						...
						oe = function () {
							(ye = "translateZ(0)"), u.setStyle(se, "transform", ye);
							var e = p(se),
						...
						Te = (u.addEvent = function (e, t, n) {
							for (
								var r,
									a = function (e) {
										return (
											(e = e || o.event).target || (e.target = e.srcElement),
											e.preventDefault ||
								...
								(r = t[i]),
									e.addEventListener
										...
										: e.attachEvent("on" + r, a),
									Ge.push({ element: e, name: r, listener: n });
						}),
							...
							(Ne = 0),
								...
								(function () {
									...
									for (s = 0, c = ie.length; c > s; s++)
										for (
											...
											(u = (i = r[o]).offset),
												(f = v[i.constant] || 0),
												(i.frame = u),
												i.isPercentage && ((u *= p), (i.frame = u)),
												"relative" === i.mode &&
													(re(t),
													(i.frame =
														ae.relativeToAbsolute(
															n,
															i.anchors[0],
															i.anchors[1]
														) - u),
									...
									for (Ne = d.max(Ne, xe()), s = 0, c = ie.length; c > s; s++) {
										for (
											o = 0, a = (r = (e = ie[s]).keyFrames).length;
											a > o;
											o++
										)
								...
								ze
									? ae.setScrollTop(d.min(ae.getScrollTop(), Ne))
									: ae.setScrollTop(e, !0),
								(ge = !0);
						},
						Ae = function () {
